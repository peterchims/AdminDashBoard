          ...
          >
            ...
            <div>
              <Routes>
                ...
                <Route path="/employees" element={<Employee />} /> {/* Corrected to lowercase */}
                <Route path="/customers" element={<Customers />} />

                {/* Apps */}
                <Route path="/kanban" element={<Kanban />} />
                <Route path="/editor" element={<Editor />} />
                <Route path="/calendar" element={<Calendar />} /> {/* Fixed spelling from "calender" */}
                ...
                <Route path="/pie" element={<Pie />} /> {/* Fixed typo "/lpie" to "/pie" */}
